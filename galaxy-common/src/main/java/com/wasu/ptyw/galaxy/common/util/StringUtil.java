...
import static com.wasu.ptyw.galaxy.common.constant.BasicConstant.EMPTY_STRING;
...
public class StringUtil {
	...
	public static String uncapitalize(String str) {
		...
		if (strLen > 1 && Character.isUpperCase(str.charAt(1))
	...
	public static String join(Object[] array, String separator) {
		...
		if (arraySize == 0) {
			...
			int firstLength = array[0] == null ? 16 : array[0].toString()
					.length();
	...
	private final static Pattern CRLF_PATTERN = Pattern
			.compile("\\r|\\n|\\r\\n");
